...
class _PaginatedDemoState extends State<PaginatedDemo> {
  ...
  void initState() {
    ...
    _scrollController.addListener(() async {
      print("Paginator currentPage: ${paginator.currentPage}, lastPage: ${paginator.lastPage}");
      print('Pixels: ${_scrollController.position.pixels}');
      print('MaxExtent: ${_scrollController.position.maxScrollExtent}');
      print('isLoading: ${paginator.isLoading}');
      print('hasNextPage: ${paginator.hasNextPage}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: (paginator.isLoading && !paginator.showProgress)
        ...
        itemCount: paginator.items.length + (paginator.showProgress ? 1 : 0),
  ...
  Future<Map<String, dynamic>> _mockFetchPosts(Map<String, dynamic> params) async {
